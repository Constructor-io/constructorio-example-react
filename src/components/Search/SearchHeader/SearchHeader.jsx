...
function SearchHeader(props) {
  ...
  return (
    <form
      ...
      className="flex flex-col sm:flex-row justify-between mb-5 sm:ml-auto sm:mr-auto"
    >
      <a
      ...
      <div className="flex sm:block mx-auto sm:mx-0 w-full sm:w-auto">
        ...
        <select
          className="w-1/2 sm:w-full cursor-pointer m-2 p-2 mr-0 sm:mr-2 border-2 rounded-lg outline-none"
